...
{
    public partial class User : Mobilize.WebMap.Common.Core.IObservable, Mobilize.WebMap.Common.Core.IDelta
    {
#line hidden
        ...
        protected virtual System.Collections.Generic.IEnumerable<string> _Mobilize_GetChanges()
        {
            ...
            if ((_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_Permissions) > 0)
            {
            ...
            if ((_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_Email) > 0)
            {
                yield return "Email";
            }
        ...
        protected virtual bool _Mobilize_HasChanges(string propertyName)
        {
            switch (propertyName)
            {
                ...
                case "Permissions":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_Permissions) > 0;
                case "Password":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_Password) > 0;
                case "Email":
                    return (_Mobilize_DirtyFlag_0 & _Mobilize_Dirty_Email) > 0;
            }
        ...
        const uint _Mobilize_Dirty_Name = (uint)1 << 0;
        const uint _Mobilize_Dirty_Permissions = (uint)1 << 1;
        const uint _Mobilize_Dirty_Password = (uint)1 << 2;
        const uint _Mobilize_Dirty_Email = (uint)1 << 3;
#line 14
    }
}