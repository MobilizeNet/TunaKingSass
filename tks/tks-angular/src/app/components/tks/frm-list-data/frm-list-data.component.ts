...
@Component({
   selector : "tks-frm-list-data",
   styleUrls : ["./frm-list-data.component.scss"],
   templateUrl : "./frm-list-data.component.html",
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["frmTKSfrmListData"])
export class frmListDataComponent extends FormComponent {
