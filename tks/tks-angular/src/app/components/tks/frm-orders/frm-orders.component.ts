...
@Component({
   selector : "tks-frm-orders",
   styleUrls : ["./frm-orders.component.scss"],
   templateUrl : "./frm-orders.component.html",
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["frmTKSfrmOrders"])
export class frmOrdersComponent extends FormComponent {
